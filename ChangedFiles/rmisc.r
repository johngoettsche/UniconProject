...

/*
 * If a name starts with &, return a descriptor with its current value.
 * add to h/rproto.h
 * add the rest of the keywords
 * do not remove keywords from getvar
 * code to use getkeyword different from code to use getvar because:
 *    getvar returned a variable descriptor, but getword just returns the
 *    value descriptor. No dereference will be needed.
 */
